#### cluster_perrelationship function

#### Social Network Survey package
#### 9.23.2019
#### cluster information per relationship

cluster_perrelationship <- function(qualtricsoutput, relationshipdf) {
  ...
  for (s in 1:length(subjids)) {
    ...
    for (i in starti:endi) {
      ...
      ############################################## PARENT 3
      if (relationshipdf$Nodes[i] == "Parent 3") {
        print("s")
        print(s)
        # 's' will specify what row to look for in the qualtricsoupt, we need the column index
        indexcol <- grep("Please.answer.the.following.questions.for.this.person.people...Selected.Choice", colnames(qualtricsoutput))
      ...
      ############################################## SIBLING 3
      if (relationshipdf$Nodes[i] == "Sibling 3") {
        print("s")
        print(s)
        # 's' will specify what row to look for in the qualtricsoupt, we need the column index
        indexcol <- grep("Please.answer.the.following.questions.for.this.person.people...Selected.Choice", colnames(qualtricsoutput))
